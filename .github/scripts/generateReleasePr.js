...
import { buildMarkdown, formatDate, groupByAuthor } from './releaseHelpers';
...
const main = () => {
  ...
  // PR作成 ---
  gh(`pr create --title 'Release/${formatDate(now)}' --base main --head ${releaseBranch} --body-file release_body.md`);
};
