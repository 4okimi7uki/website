import { buildMarkdown, groupByAuthor } from '../releaseHelpers';
    ...
    expect(result).toEqual([
      {
        ...
        prs: [
          ...
          { number: 1236, title: '【ALBA_OPERATION-1629】【大会LB・獲得賞金】開催地時刻の⏰アイコン削除依頼' }
        ]
      },
      {
        author: 'haruka919',
        prs: [
          ...
          { number: 1243, title: '【ALBA_OPERATION-1670】 共通コンポーネント（KeywordItemなど）のStorybook化' },
